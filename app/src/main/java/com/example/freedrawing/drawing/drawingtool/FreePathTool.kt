...
import com.example.freedrawing.drawing.figure.FreePath
...
class FreePathTool(
    ...
    override fun dragStart(offset: Offset) {
        ...
        ir?.newFigure(owner, FreePath(color, style.drawStyle))
    }
    ...
    override fun toDrawingToolValue(): DrawingToolValue = DrawingToolValue.FreePathTool
